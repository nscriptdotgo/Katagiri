...
function init_gear_sets()
	...
	sets.HPDown = {head="Pixie Hairpin +1",neck="Twilight Torque",ear1="Mendicant's Earring",ear2="Evans Earring",
	...
	sets.precast.WS = {ammo="Aurgelmir Orb +1",
				  head="Lilitu Headpiece",neck="Light Gorget",ear1="Cessance Earring",ear2="Brutal Earring",
                  body="Adhemar Jacket +1",hands="Jhakri Cuffs +1",ring1="Epona's Ring",ring2="Apate Ring",
				  back=gear.da_jse_back,waist="Light Belt",legs="Samnuha Tights",feet=gear.herculean_ta_feet}
	...
	sets.precast.WS.DT = {ammo="Aurgelmir Orb +1",
				  head="Malignance Chapeau",neck="Twilight Torque",ear1="Cessance Earring",ear2="Brutal Earring",
	...
	sets.precast.WS['Chant du Cygne'] = set_combine(sets.precast.WS, {
		ammo="Ginsen",
		head={ name="Adhemar Bonnet", augments={'DEX+12','AGI+12','Accuracy+20',}},
		body={ name="Herculean Vest", augments={'"Triple Atk."+4','STR+1','Attack+13',}},
		hands={ name="Adhemar Wrist.", augments={'STR+12','DEX+12','Attack+20',}},
	...
	sets.engaged = {
		...
		legs={ name="Herculean Trousers", augments={'Rng.Acc.+16','"Triple Atk."+3','AGI+7','Accuracy+3',}},
		feet={ name="Carmine Greaves", augments={'Accuracy+10','DEX+10','MND+15',}},
	}
	...
	sets.engaged.DT = {main="Tizona",sub="Almace",ammo="Aurgelmir Orb +1",
			    head="Malignance Chapeau",neck="Twilight Torque",ear1="Suppanomimi",ear2="Brutal Earring",
	...
	sets.engaged.Acc.DT = {main="Tizona",sub="Almace",ammo="Falcon Eye",
			    head="Malignance Chapeau",neck="Twilight Torque",ear1="Cessance Earring",ear2="Telos Earring",
	...
	sets.engaged.Acc.DT.AM = {main="Tizona",sub="Almace",ammo="Falcon Eye",
			    head="Malignance Chapeau",neck="Twilight Torque",ear1="Digni. Earring",ear2="Telos Earring",
			    body="Malignance Tabard",hands="Malignance Gloves",ring1="Defending Ring",ring2="Ilabrat Ring",
			    back=gear.stp_jse_back,waist="Reiki Yotai",legs="Malignance Tights",feet="Malignance Boots"}
