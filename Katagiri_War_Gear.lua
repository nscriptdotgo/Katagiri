...
function init_gear_sets()
    ...
    sets.precast.WS = {ammo="Knobkierrie",
		...
		body=gear.valorous_wsd_body,hands="Sulev. Gauntlets +2",ring1="Raja Ring",ring2="Niqmaddu Ring",
		back=gear.wsd_str_jse_back,waist="Light Belt",legs="Sulev. Cuisses +2",feet="Flam. Gambieras +2"}
