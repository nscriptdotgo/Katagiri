...
function init_gear_sets()
    ...
    sets.precast.WS["Mandalic Stab"].SA = set_combine(sets.precast.WS["Mandalic Stab"].Fodder, {ammo="Yetshila +1",head="Adhemar Bonnet +1 +1",body="Meg. Cuirie +2",legs="Pill. Culottes +1"})
    sets.precast.WS["Mandalic Stab"].TA = set_combine(sets.precast.WS["Mandalic Stab"].Fodder, {ammo="Yetshila +1",head="Adhemar Bonnet +1 +1",body="Meg. Cuirie +2",legs="Pill. Culottes +1"})
    sets.precast.WS["Mandalic Stab"].SATA = set_combine(sets.precast.WS["Mandalic Stab"].Fodder, {ammo="Yetshila +1",head="Adhemar Bonnet +1 +1",body="Meg. Cuirie +2",legs="Pill. Culottes +1"})
    ...
    sets.precast.WS['Evisceration'] = set_combine(sets.precast.WS, {ammo="Qirmiz Tathlum",
        head="Uk'uxkaj Cap",neck="Rancor Collar",ear1="Cessance Earring",ear2="Moonshade Earring"})    sets.precast.WS['Evisceration'].SomeAcc = set_combine(sets.precast.WS.SomeAcc, {ammo="Yetshila +1",head="Adhemar Bonnet +1 +1",ear1="Moonshade Earring",ear2="Odr Earring",neck="Fotia Gorget",body="Abnoba Kaftan",hands="Mummu Wrists +2",ring1="Begrudging Ring",waist="Fotia Belt",legs="Mummu Kecks +2",feet="Mummu Gamash. +2"})
    ...
    sets.midcast.RA = {
        ...
        body="Malignance Tabard",hands="Malignance Gloves",ring1="Apate Ring",ring2="Regal Ring",
        back=gear.stp_jse_back,waist="Chaac Belt",legs="Malignance Tights",feet="Malignance Boots"}
    ...
    sets.engaged.SomeAcc = {ammo="Aurgelmir Orb +1",
        ...
        back=gear.stp_jse_back,waist="Reiki Yotai",legs="Samnuha Tights",feet=gear.herculean_ta_feet}
	...
	sets.engaged.Acc = {ammo="Yamarang",
        ...
        back=gear.stp_jse_back,waist="Olseni Belt",legs="Pill. Culottes +1",feet="Malignance Boots"}
