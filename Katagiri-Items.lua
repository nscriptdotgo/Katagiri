...
gear.odyssean_wsd_head = { name="Odyssean Helm", augments={'Accuracy+14','Weapon skill damage +5%','Attack+1',}}
gear.odyssean_wsd_legs = { name="Odyssean Cuisses", augments={'Accuracy+8 Attack+8','Weapon skill damage +4%','STR+7','Accuracy+7',}}
gear.odyssean_fc_body =  { name="Odyssean Chestplate", augments={'MND+11','"Fast Cast"+3','Accuracy+14',}}
gear.odyssean_stp_legs = { name="Odyssean Cuisses", augments={'"Dbl.Atk."+5','DEX+8','Accuracy+2',}}
gear.odyssean_fc_legs = { name="Odyssean Cuisses", augments={'Mag. Acc.+21','"Fast Cast"+5','MND+10',}}
...
gear.valorous_wsd_body = {name="Valorous Mail",augments={'Accuracy+28','Weapon skill damage +2%','VIT+9','Attack+12',}}
